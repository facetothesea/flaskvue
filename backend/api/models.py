...
class Package(db.Model):
    ...
    id=db.Column(db.Integer,primary_key=True) 
    describe=db.Column(db.Enum('千克','件','托','箱','只','支','组','卷','立方米','平方米')) #包装方式
    # material_id=db.Column(db.Integer,db.ForeignKey('material.id'))
...
class Inventory(db.Model):
    ...
    def __repr__(self):
        return '< Inventory 库存 {} {} {} {} {} > '.format(self.allocation,self.code,self.name,self.inventory_acount,self.lastdt)
